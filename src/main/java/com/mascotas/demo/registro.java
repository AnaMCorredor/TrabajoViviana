...
public class registro {
    ...
    //Buscar------------------------------------------------------------------------------------------
    public void Buscar_Omar(){
        System.out.println("MOSTRAR TODAS TUS MASCOTAS");
        // For mejorado para imprimir
        for (int i = 0; i < mascota.size(); i++) {
            System.out.println("<----------------------------------------------------------->");
            System.out.println("Nombre:" + mascota.get(i).getNombre()+ "\n");
            System.out.println("Documento:" + mascota.get(i).getDocumentoMas()+ "\n");
            System.out.println("Dueño:" + mascota.get(i).getDueño()+ "\n");
            System.out.println("Raza:" + mascota.get(i).getRaza()+ "\n");
            System.out.println("Color" + mascota.get(i).getColor()+ "\n");
            System.out.println("<----------------------------------------------------------->");
